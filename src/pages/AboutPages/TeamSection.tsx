      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16 lg:mb-20">
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight tracking-tight">
            Our team has over <span className="text-gray-400">100 years</span><br className="hidden lg:block" /> of combined experience!
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {teamMembers.map((member, idx) => (
            <div key={idx} className="bg-white rounded-3xl p-8 hover:shadow-xl transition-all duration-300 flex flex-col items-center text-center border border-transparent hover:border-gray-100 group">
              {/* Image Container */}
              <div className="w-32 h-32 rounded-full mb-6 relative p-1 bg-white shadow-sm group-hover:scale-105 transition-transform duration-300">
                <img 
                  src={member.image} 
                  alt={member.name} 
              ...
              <p className="text-brand-purple font-bold text-xs uppercase tracking-wider mb-6">{member.role}</p>
