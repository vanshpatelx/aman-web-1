    ...
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16 lg:mb-20">
          <h2 className="text-4xl lg:text-5xl font-medium text-gray-900 mb-6 leading-tight tracking-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {teamMembers.map((member, idx) => (
            <div key={idx} className=" p-8 border-r-[1px] flex flex-col items-center text-center bg-white  border-gray-200 group">
              {/* Image Container */}
              <div className="w-32 h-32 rounded-full mb-6 relative p-1 bg-white shadow-sm  transition-transform duration-300">
                <img 
                  src={member.image} 
                  alt={member.name} 
              ...
              {/* Content */}
              <h3 className="text-2xl font-normal text-gray-900 mb-1">{member.name}</h3>
              <p className="text-brand-purple font-normal text-xs uppercase tracking-wider mb-4">{member.role}</p>
